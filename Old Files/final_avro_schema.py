# -*- coding: utf-8 -*-
"""Final_AVRO Schema.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1Tvp1TEAeytip5N9m-ox-AXKI2n2viV4E
    ...
    },
    {
      ...
      "type": {
        ...
        "fields": [
          ...
          {"name": "InteractionTimestamp", "type": "long", "logicalType": "timestamp-millis"},
        ]
      }
    }
  ]
...
schema_ind = {
  ...
  "namespace": "com.spotify.wrapped",
  "fields": [
    # Schema fields as provided
  ]
}

# Parse the schema using fastavro
parsed_schema = fastavro.parse_schema(schema_ind)
def generate_listening_session(user_id, start_time, end_time, preferred_genre="dance pop"):
    records = []
    ...
    while session_start < session_end:
        ...
        listening_device = "Mobile"
        interaction_type = random.choice(["PLAY", "PAUSE", "SKIP", "LIKE", "DISLIKE"])

        interaction_timestamp = session_start.astimezone(timezone.utc).strftime('%Y-%m-%dT%H:%M:%SZ')
        ...
        session_start += timedelta(minutes=4)  # Simplified assumption

    return records

"""Genearting for multiple users"""
...
def generate_multiple_users_sessions(num_users, start_time, end_time, genre_list):
    ...
    for _ in range(num_users):
        ...
        user_records = generate_listening_session(user_id, start_time, end_time, preferred_genre)
...
start_time = '2021-04-01T10:00:00-05:00'
end_time = '2021-04-01T12:00:00-05:00'
